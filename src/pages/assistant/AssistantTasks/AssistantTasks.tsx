                      ...
                      <div className="at-submit-form">
                          ...
                          >
                            {submitPreview ? (
                              ...
                              <>
                                ...
                                <span className="at-upload-zone__hint">
                                  JPG, PNG, WebP
                                </span>
                              </>
                            )}
                        ...
                        <div className="at-submit-form__footer">
                          ...
                          >
                            {uploading ? (
                              <>
                                <Loader2 size={13} className="at-spin" /> Upload
                                ảnh...
                              </>
                            ) : submitting ? (
                              <>
                                <Loader2 size={13} className="at-spin" /> Đang
                                nộp...
                              </>
                            ) : (
                              <>
